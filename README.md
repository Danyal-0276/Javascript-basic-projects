...
| 4 | **Custom Select Menu** | `Custom Select Menu/` | Styled dropdown for social media platforms | CSS layout, custom UI *(JS pending)* |
...
| 13 | **Quote Generator** | `Quote gen App/` | Fetch random quotes from a public API | `fetch()`, async/await *(UI wiring in progress)* |
